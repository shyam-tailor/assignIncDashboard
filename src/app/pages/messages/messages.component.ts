...
export class MessagesComponent implements OnInit {
  ...
  isLogged: any;
  role: any;
  constructor(private observer: BreakpointObserver, private router: Router, private fb: FormBuilder, public commonsvc: CommonServiceService, private modalService: BsModalService) {
  ...
  getMessages() {
    this.userData = localStorage.getItem('userDetails')
    this.userData = JSON.parse(this.userData)
    this.commonsvc.getmessages(this.userData.username).subscribe(
      (result: any) => {
